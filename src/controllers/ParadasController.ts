  ...
  async index(request: Request, response: Response) {
    try {
      ...
      return response.status(400).json({
        error:
          'Não foi possível listar os registros da tabela "parada". It was not possible to list the records in the "parada" table',
      });
    }
  }
  ...
  async indexOneByID(request: Request, response: Response) {
    try {
      ...
      response.status(404).json({
        error:
          'Não foi possível encontrar este registro da tabela "parada". It was not possible to find this record in the "parada" table',
      });
    }
  }
